  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/admin/config" element={<RequireAuth><RequireAdmin><AdminConfigPage /></RequireAdmin></RequireAuth>} />
        <Route path="/admin/tutorials" element={<RequireAuth><RequireAdmin><AdminTutorialsPage /></RequireAdmin></RequireAuth>} />
